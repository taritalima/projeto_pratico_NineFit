...
include_once("../../projeto_pratico _2/php/conexao.php");
...
if ($row[0] > 0) {
    echo "<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost:8080/projeto_pratico%20_2/php/cadastro.php'>
    ...
    if (mysqli_affected_rows($conn) != 0) {
        ...
        echo "
                    <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost:8080/projeto_pratico%20_2/php/cadastro.php'>
                    <script type='text/javascript'>
